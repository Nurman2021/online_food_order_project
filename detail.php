...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>BonnyID | BonnyID Online telengkap dan terpercaya </title> 
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span2">
					...
					<a class="brand" href="#"><img src="img/logo3.jpeg" alt="Logo"></a>
			    		...
			    		<div class="navbar-inner">
			          		...
			          		<div class="nav-collapse collapse">
			            		<ul class="nav">
			              			...
			              			<li><a href="produk.php">Produk Makanan</a></li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="span3">					
					...
					<p>
					Bonny ID adalah toko online yang bergerak di bidang Makanan, sasaran kami semua kalangan baik muda maupun tua, mulai dari anak - anak dan orang dewasa.
					</p>
